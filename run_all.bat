...
g++ -std=c++17 -O2 -Wall -Wextra -Isrc -I"%QT_DIR%\include" -I"%QT_DIR%\include\QtWidgets" -I"%QT_DIR%\include\QtGui" -I"%QT_DIR%\include\QtCore" src\main.cpp src\ngram.cpp src\vptree.cpp src\engine.cpp src\mainwindow.cpp build_terminal\moc_mainwindow.cpp -o build_terminal\VPTreePlagiarismDetector.exe -L"%QT_DIR%\lib" -lQt6Widgets -lQt6Gui -lQt6Core -mwindows
if errorlevel 1 (
